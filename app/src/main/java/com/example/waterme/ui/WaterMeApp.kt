...
fun PlantListItem(plant: Plant, onItemSelect: (Plant) -> Unit, modifier: Modifier = Modifier) {
    Card(modifier = modifier
        ...
        Column(
            ...
            Text(text = stringResource(plant.type), style = MaterialTheme.typography.titleMedium)
            Text(text = stringResource(plant.description), style = MaterialTheme.typography.titleMedium)
            Text(
